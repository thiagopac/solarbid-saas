...
?>
    ...
    <div class="form-group">
        ...
        <input type="text" id="power_plants_installed" name="power_plants_installed" value="<?=$company_profile->power_plants_installed;?>" class="form-control"/>
    </div>
    <div class="form-group">
        <label for="value">
        ...
        <div class="input-group">
            ...
            <input type="text" id="power_executed" name="power_executed" class="required form-control"  value="<?php if(isset($company_profile)){echo $company_profile->power_executed;}?>"  required/>
        </div>
    </div>
