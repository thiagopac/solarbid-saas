    ...
    <div class="col-md-9 col-lg-10">
                    ...
                    <small style="padding-left:10px">
						<span class="tag tag--grey">
							<?php if (!empty($settings->ticket_config_timestamp)) {
                                ...
                                echo 'O postmaster ainda não foi executado. Checar o cronjob.';
                            }?>
						</span>
                    </small>
                </div>
        ...
        <div class="box-shadow">
            <div class="table-head">
                ...
                <span class="pull-right">
						<a href="<?=base_url()?>settings/ticket_type" class="btn btn-primary flat-invert" data-toggle="mainmodal">
        ...
        <div class="box-shadow">
            <div class="table-head">
                ...
                <span class="pull-right">
						<a href="<?=base_url()?>settings/ticket_queue" class="btn btn-primary flat-invert" data-toggle="mainmodal">
