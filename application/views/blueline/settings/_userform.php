...
?>
    ...
    <div class="form-group">
        <label for="username">
            <?=$this->lang->line('application_username');?> *</label>
    ...
    <div class="form-group">
        <label for="signature">
            <?=$this->lang->line('application_signature');?>
        </label>
...
<?php if (!isset($agent)) {
    ...
    <div class="form-group">
        <label for="title">
            <?=$this->lang->line('application_user_role'); ?> *</label>
    ...
    <div class="form-group">
        <label for="status">
            <?=$this->lang->line('application_ticket_queue'); ?>
        </label>
        <?php $options = [];
    ...
    <div class="form-group">
        <label for="admin">
            <?=$this->lang->line('application_departments_worker_has_functions'); ?>
        </label>
        <?php
        $options = array();
        $department = array();
    ...
    <div class="form-group">
        ...
        <ul class="accesslist">
            ...
            <?php foreach ($modules as $key => $value) {
                ...
                <li>
                    <input type="checkbox" class="checkbox" id="r_<?=$value->link; ?>" name="access[]" data-labelauty="<?=$this->lang->line('application_' . $value->link); ?>" value="<?=$value->id; ?>" <?php if (in_array($value->id, $access)) { echo 'checked="checked"'; } ?>> </li>
                <?php
            } ?>
        </ul>
    </div>
