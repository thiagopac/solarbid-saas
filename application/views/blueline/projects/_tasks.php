...
<div class="form-group">
    <label for="name">
        <?=$this->lang->line('application_task_name');?> *</label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="milestone_id">
                <?=$this->lang->line('application_milestone');?>
            </label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="scheduled_time">
                <?=$this->lang->line('application_scheduled_time');?>
            </label>
            <input id="scheduled_time" type="number" min="0" max="99" size="2" name="scheduled_time" class="form-control resetvalue" <?=$this->user->admin == 0 ? "disabled" : "";?> value="
                        <?php if(isset($task)){echo $task->scheduled_time;} ?>" />
        </div>
    </div>
</div>
...
<div class="form-group">
    <label for="user">
        <?=$this->lang->line('application_assign_to_agent');?>
    </label>
    <?php $users = array();
    $users['0'] = '-';
...
<div class="form-group">
    <label for="sucessors_ids">
        <?=$this->lang->line('application_sucessor_tasks');?>
    </label>
    <?php
    $options = array();
    $sucessor = array();
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label for="priority">
                <?=$this->lang->line('application_priority');?>
            </label>
            <?php $prioritys = array();
            $prioritys['0'] = '-';
...
<div class="form-group">
    ...
    <textarea class="input-block-level summernote-modal" id="textfield" name="description">
                    <?php if(isset($task)){echo $task->description;} ?>
                </textarea>
</div>
...
<div class="modal-footer">
    ...
    <?php }else{  ?>
        ...
        <button id="send" name="send" data-keepModal="true" class="btn btn-primary send button-loader">
            <?=$this->lang->line('application_save_and_add');?>
        </button>
    <?php } ?>
    <button name="send" class="btn btn-primary send button-loader">
