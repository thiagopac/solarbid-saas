...
<div class="top-background">
   <table width="100%" cellspacing="0" >
        ...
        echo base_url();
           ...
           <td style="vertical-align: top;"><div class="status <?php echo strtolower($status);?>"> <?=$this->lang->line('application_' . $status);?></div></td>
         </tr>
         <tr >
        ...
        <tr>
            <td style="vertical-align:top"><?php if ($invoice->company->state != '') {
        ?><?=$invoice->company->state; ?><?php
    } ?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="vertical-align:top"><?php if ($invoice->company->vat != '') {
...
<div class="content">
  ...
  <?php $i = 0; $sum = 0; $row = false; ?>
    ...
    <?php $sum = $sum + $invoice->invoice_has_items[$i]->amount * $invoice->invoice_has_items[$i]->value; $i++; if ($row) {
        $row = false;
    } else {
        $row = true;
    }?>
