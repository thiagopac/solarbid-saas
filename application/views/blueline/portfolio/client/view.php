    ...
    <div class="grid">
                                ...
                                <div class="table-div responsive">
                                    ...
                                    <ul class="list-group ">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <label class="stats-label"><i
                                                        class="dripicons-arrow-right orangered stats-icon"></i> <?= $this->lang->line('application_warranty_lowest') ?>
                                            </label>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <label class="stats-label"><i
                                                        class="dripicons-arrow-up orangered stats-icon"></i> <?= $this->lang->line('application_warranty_highest') ?>
                                            </label>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <label class="stats-label"><i
                                                        class="dripicons-view-thumb orangered stats-icon"></i> <?= $this->lang->line('application_power_plants_installed') ?>
                                            </label>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <label class="stats-label"><i
                                                        class="dripicons-pulse orangered stats-icon"></i> <?= $this->lang->line('application_power_executed') ?>
                                            </label>
        ...
        <div class="media-list-view-container grid__col-sm-12 grid__col-md-3 grid__col-lg-3 grid__col--bleed">
            <div class="box-shadow">
                ...
                <div class="table-div">
                    <table id="photos" class="table data-media noclick"
                           rel="<?= base_url() ?>cportfolio/photo/<?= $this->client->company_id; ?>" cellspacing="0"
                           cellpadding="0">
                        <thead>
                            <tr>
                        ...
                        <?php foreach ($company_photos as $file): ?>
                            <tr id="<?= $file->id; ?>">
                                ...
                                <td style="text-align: center">
                                    <a href="<?= base_url() ?>cportfolio/download_photo/<?= $file->id ?>"><i
                                                class="icon dripicons-download"> </i></a>
                                </td>
                                <td class="option">
                                    <button type="button" class="btn-option btn-xs po tt"
                                            title="<?= $this->lang->line('application_delete'); ?>"
                                            data-toggle="popover" data-placement="left"
                                            data-content="<a class='btn btn-danger po-delete ajax-silent' href='<?= base_url() ?>cportfolio/delete_photo/<?= $file->id; ?>'><?= $this->lang->line('application_yes_im_sure'); ?></a> <button class='btn po-close'><?= $this->lang->line('application_no'); ?></button> <input type='hidden' name='td-id' class='id' value='<?= $file->id; ?>'>"
                                            data-original-title="<b><?= $this->lang->line('application_really_delete'); ?></b>">
                                        <i class="icon dripicons-cross"> </i></button>
                                    <a href="<?= base_url() ?>cportfolio/preview_photo/<?= $file->id; ?>"
                                       title="<?= $this->lang->line('application_preview_photo'); ?>"
                                       class="btn-option tt" data-toggle="mainmodal"> <i
