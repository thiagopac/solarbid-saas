<div class="row tile-row">
    <div class="tile-button">
        <a href="<?= base_url() ?>ctokens/find" data-toggle="mainmodal">
    ...
    <div class="tile-button">
        <a href="<?= base_url() ?>ctokens/list_simulator">
            <div class="col-md-3 col-xs-3 tile">
    ...
    <div class="tile-button">
        <a href="<?= base_url() ?>ctokens/list_store">
            <div class="col-md-3 col-xs-3 tile">
                <div class="icon-frame"><i class="ion-android-cart"></i></div>
                <h1><span><?= $this->lang->line('application_store_tokens'); ?></span></h1>
            </div>
        </a>
    </div>
