                        ...
                        <div class="subcont">
                            <ul class="details">
                                ...
                                <li><span> <?= $this->lang->line('application_appointment'); ?>:
                                        <?php if ($flow->integrator_approved != 1) : ?>
                                            <a data-toggle="mainmodal" href="<?= base_url() ?>cappointments/edit_event/<?= $flow->code; ?>/ctokens-simulator" style="padding: 4px 6px;" class="btn-small btn-primary pull-right"><?=$this->lang->line('application_change_appointment');?></a>
                                        <?php endif; ?>
                                    </span>
                                    <?php if (empty($flow->integrator)) : ?>
                                        -
