        ...
        <div class="grid__col-sm-12 grid__col-md-12 grid__col-lg-12 grid__col--bleed">
            <div class="grid grid--align-content-start">
                    ...
                    <div class="box-shadow">
                        ...
                        <div class="subcont">
                            <ul class="details">
                                ...
                                <li><span> <?= $this->lang->line('application_appointment'); ?>:
                                        <?php if ($flow->integrator_approved != 1) : ?>
                                            <a data-toggle="mainmodal" href="<?= base_url() ?>cappointments/edit_event/<?= $flow->code; ?>/ctokens-store" style="padding: 4px 6px;" class="btn-small btn-primary pull-right"><?=$this->lang->line('application_change_appointment');?></a>
                                        <?php endif; ?>
                                    </span>
                                    <?php if (empty($flow->integrator)) : ?>
                                        -
                                    <?php else : ?>
                                        <small>
                                            ...
                                            <br/>
                                            <strong><?= $this->lang->line('application_concluded_visit') ?></strong>: <span style="vertical-align: middle;" class="label <?=$company_appointment->completed == 1 ? 'label-success' : 'label-important' ?>"><?= $company_appointment->completed == 1 ? $this->lang->line('application_yes') : $this->lang->line('application_no') ?></span>
                                        </small>
                                    <?php endif; ?>
                                </li>
                ...
                <div class="col-md-9">
                    ...
                    <div class="box-shadow">
                        <div class="table-head">
                            <?= $this->lang->line('application_revise_pv_kit_and_complement'); ?></div>
                        <div class="subcont">
                                ...
                                <div class="grid grid--align-content-start">
                                    ...
                                    <div class="grid__col-5 grid__col-xs-5 grid__col-sm-5 grid__col-md-5 grid__col-lg-5">
                                        <div class="tile-base box-shadow tile-with-icon">
                                            ...
                                            <div class="tile-body" style="min-height: 230px;">
                                                <p style="margin-top: 20px">
                                                    <small>
                                                        <small>
                                                            <strong><?= $this->lang->line('application_pv_power') ?></strong>: <?= $pv_kit_view->kit_power ?> <?= $core_settings->rated_power_measurement; ?>
                                                            <br/>
                                                            <strong><?= $this->lang->line('application_inverter') ?></strong>: <?= $pv_kit_view->pv_inverter ?>
                                                            <br/>
                                                            <strong><?= $this->lang->line('application_desc_inverter') ?></strong>: <?= $pv_kit_view->desc_inverter ?>
                                                            <br/>
                                                            <strong><?= $this->lang->line('application_modules') ?></strong>: <?= $pv_kit_view->pv_module ?>
                                                            <br/>
                                                            <strong><?= $this->lang->line('application_desc_module') ?></strong>: <?= $pv_kit_view->desc_module ?>
                                                            <br/>
                                                            <strong><?= $this->lang->line('application_structure_type') ?></strong>: <?= StructureType::find($pv_kit_view->structure_type_id)->name ?>
                                                            <br/>
                                                            <strong><?= $this->lang->line('application_price') ?></strong>: <?= $core_settings->money_symbol; ?><?= display_money($pv_kit_view->price) ?>
                                                            <br/>
                                                            <strong><?= $this->lang->line('application_freight') ?></strong>: <?= $core_settings->money_symbol; ?><?= display_money($pv_kit_view->freight) ?>
                                                            <br/>
                                                            <strong><?= $this->lang->line('application_insurance') ?></strong>: <?= $pv_kit_view->insurance ?>
                                                            <!--                                                        <strong>--><?//= $this->lang->line('application_freight') ?><!--</strong>: --><?//= $core_settings->money_symbol; ?><!----><?//= display_money($pv_kit_view->freight) ?>
                                                            <br/>
                                                        </small>
                                                    </small>
                                            ...
                                            <div class="tile-bottom">
                                                <?php if ($flow->pv_kit_revised != null) : ?>
                                                    <div class="pull-left"><div class="badge btn-danger"><?=$this->lang->line('application_kit_changed_integrator');?></div></div>
                                                <?php endif; ?>
                                                <?php if ($flow->integrator_approved != 1) : ?>
                                        ...
                                        <div class="tile-base box-shadow tile-with-icon">
                                            ...
                                            <div class="tile-bottom">
                                                <?php if ($flow->complements_revised != null) : ?>
                                                    <div class="pull-left"><div class="badge btn-danger"><?=$this->lang->line('application_complements_changed_integrator');?></div></div>
                                                <?php endif; ?>
                                                <?php if ($flow->integrator_approved != 1) : ?>
